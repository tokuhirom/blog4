...
type UploadFileRequestMultipart struct {
	File ht.MultipartFile `json:"file"`
}

// GetFile returns the value of File.
func (s *UploadFileRequestMultipart) GetFile() ht.MultipartFile {
	return s.File
}

// SetFile sets the value of File.
func (s *UploadFileRequestMultipart) SetFile(val ht.MultipartFile) {
	s.File = val
}
